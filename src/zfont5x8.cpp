...
const PROGMEM uint8_t zfont5x8[] = { 
  ...
  // Numbers at full 8 pixels height
  0x7e, 0x81, 0x81, 0x81, 0x7e, // 0x30 0
  //0x7C, 0xA2, 0x92, 0x8A, 0x7C,// 0x30 0

  0x84, 0x82, 0xff, 0x80, 0x80, // 0x31 1
  //0x00, 0x84, 0xFE, 0x80, 0x00,// 0x31 1

  0xc2, 0xa1, 0x91, 0x89, 0x86, // 0x32 2
  // 0x84, 0xC2, 0xA2, 0x92, 0x8C,// 0x32 2

  0x42, 0x81, 0x89, 0x89, 0x76, // 0x33 3
  //0x42, 0x82, 0x8A, 0x96, 0x62,// 0x33 3 

  0x18, 0x14, 0x12, 0xff, 0x10, // 0x34 4
  // 0x30, 0x28, 0x24, 0xFE, 0x20,// 0x34 4 

  0x47, 0x85, 0x85, 0x85, 0x79, // 0x35 5
  // 0x4E, 0x8A, 0x8A, 0x8A, 0x72,// 0x35 5 

  0x7e, 0x89, 0x89, 0x89, 0x72, // 0x36 6
  // 0x78, 0x94, 0x92, 0x92, 0x60,// 0x36 6 

  0xe1, 0x11, 0x09, 0x05, 0x03, // 0x37 7
  // 0x02, 0xE2, 0x12, 0x0A, 0x06,// 0x37 7

  0x76, 0x89, 0x89, 0x89, 0x76, // 0x38 8 
  // 0x6C, 0x92, 0x92, 0x92, 0x6C,// 0x38 8

  0x4e, 0x91, 0x91, 0x91, 0x7e, // 0x39 9
